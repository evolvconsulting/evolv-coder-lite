/**
 * CLI Transport — renders eCL events as rich ANSI-colored output to a Writable stream.
 *
...
export class CLITransport implements TransportHandler {
  ...
  /** Format and write a eCL event as a rich ANSI-colored line. Never throws. */
  ...
  private formatEvent(event: GSDEvent): string {
    ...
    switch (event.type) {
      ...
      case GSDEventType.PhaseStart:
        return `${BOLD}${CYAN}━━━ eCL ► PHASE ${event.phaseNumber}: ${event.phaseName} ━━━${RESET}`;
      ...
      case GSDEventType.MilestoneStart:
        return `${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}\n${BOLD}  eCL Milestone — ${event.phaseCount} phases${RESET}\n${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}`;

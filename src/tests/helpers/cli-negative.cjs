 ...
 *
 * Wraps spawnSync of evolv-coder-lite/bin/ecl-tools.cjs so test files can
...
const TOOLS_PATH = path.resolve(__dirname, '..', '..', 'evolv-coder-lite', 'bin', 'ecl-tools.cjs');

/**
 * Run ecl-tools with the given argv against a project directory.
 *
 * @param {string[]} argv - argument vector passed to ecl-tools.cjs. Each

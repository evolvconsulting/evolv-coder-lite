 ...
 *
 * Ported from evolv-coder-lite/bin/lib/phase.cjs and core.cjs.
 ...
 *
 * Mirrors evolv-coder-lite/bin/lib/phase.cjs lines 17–52.
 */
...
export function describeNonCanonicalPlans(dirFiles: string[], matchedFiles: string[]): string | null {
  ...
  return (
    ...
    + `See agents/ecl-planner.md write_phase_prompt step for the full contract.`
  );
}

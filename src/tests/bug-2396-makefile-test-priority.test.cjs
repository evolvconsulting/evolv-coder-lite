...
const VERIFY_PHASE_PATH = path.join(__dirname, '..', 'evolv-coder-lite', 'workflows', 'verify-phase.md');
const AUDIT_FIX_PATH = path.join(__dirname, '..', 'evolv-coder-lite', 'workflows', 'audit-fix.md');

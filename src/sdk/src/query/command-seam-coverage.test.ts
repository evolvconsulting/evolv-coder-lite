...
describe('command seam coverage (manifest -> generated -> adapters)', () => {
  ...
  it('CJS seam adapters export expected router functions', () => {
    ...
    const stateRouter = require('../../../evolv-coder-lite/bin/lib/state-command-router.cjs');
    const verifyRouter = require('../../../evolv-coder-lite/bin/lib/verify-command-router.cjs');
    const initRouter = require('../../../evolv-coder-lite/bin/lib/init-command-router.cjs');
    const phaseRouter = require('../../../evolv-coder-lite/bin/lib/phase-command-router.cjs');
    const phasesRouter = require('../../../evolv-coder-lite/bin/lib/phases-command-router.cjs');
    const validateRouter = require('../../../evolv-coder-lite/bin/lib/validate-command-router.cjs');
    const roadmapRouter = require('../../../evolv-coder-lite/bin/lib/roadmap-command-router.cjs');

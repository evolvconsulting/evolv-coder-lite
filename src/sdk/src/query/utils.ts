 ...
 *
 * These handlers are direct TypeScript ports of ecl-tools.cjs functions:
...
export interface QueryResult<T = unknown> {
   ...
   * Used by `agent-skills` so workflows embedding `$(ecl-sdk query …)` receive
 ...
 *
 * Port of `cmdGenerateSlug` from `evolv-coder-lite/bin/lib/commands.cjs`.
 ...
 *
 * Port of `cmdCurrentTimestamp` from `evolv-coder-lite/bin/lib/commands.cjs`.

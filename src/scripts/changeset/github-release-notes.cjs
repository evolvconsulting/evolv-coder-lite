...
const FIXED_GROUPS = [
  ...
  },
  {
    ...
    pattern: /\b(install|installer|runtime|windows|powershell|codex|gemini|antigravity|hook|hooks|ecl-sdk|sdk readiness|cjs|model-catalog|path|shim)\b/i,
  },
];
...
const REMOVED_GROUPS = [
  {
    title: 'Intel updater',
    pattern: /\b(intel|ecl-intel-updater|layout detection)\b/i,
  },
];

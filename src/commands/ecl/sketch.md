...
integrate with eCL commit patterns, state tracking, and handoff workflows. Loads spike
...
<execution_context>
@~/.claude/evolv-coder-lite/workflows/sketch.md
@~/.claude/evolv-coder-lite/workflows/sketch-wrap-up.md

'use strict';
/**
 * Profile-pipeline command router — CLI dispatcher for ecl-tools profiling commands.
 *
 * ADR-857 phase 6 / ADR-959: profile-pipeline capability command cutover.
 * Extracted from hardcoded case arms in ecl-tools.cjs (lines 1324-1410).
 ...
 * dispatchCapabilityCommand (ecl-tools.cjs:366-371) explicitly errors if a

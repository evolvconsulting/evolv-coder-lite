...
const { routePhaseCommand } = require('../evolv-coder-lite/bin/lib/phase-command-router.cjs');

// Force CJS path throughout: set ECL_WORKSTREAM so tryLoadSdk() is bypassed.

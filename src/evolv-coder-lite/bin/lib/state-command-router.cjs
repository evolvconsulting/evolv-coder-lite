 ...
 * - Any command when ECL_WORKSTREAM is active (GSDTransport forces subprocess
...
function routeStateCommand({ state, args, cwd, raw, parseNamedArgs, error }) {
  ...
  routeCjsCommandFamily({
    ...
    unsupported: {
      'add-roadmap-evolution': 'state add-roadmap-evolution is SDK-only. Use: ecl-sdk query state.add-roadmap-evolution ...',
    },
    error,

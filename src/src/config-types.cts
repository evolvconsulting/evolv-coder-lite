/**
 * TypeScript type definitions for eCL project config — model_policy block.
 *
 ...
 * evolv-coder-lite/bin/lib/ at publish time.
 *
...
/**
 * A single tier entry mapping a eCL tier (opus | sonnet | haiku) to a
...
/**
 * The three standard eCL tiers for one runtime target. All fields are
...
/**
 * Minimal subset of the eCL project config that includes `model_policy`.

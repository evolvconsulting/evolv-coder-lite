/**
 * Tests for ecl-check-update-worker.js — Windows npm resolution platform gate.
 *
 ...
 * targets `.cjs` files in bin/lib/evolv-coder-lite — `hooks/*.js` is out of
...
describe('ecl-check-update-worker: Windows npm spawn platform gate', () => {

 ...
 * evolv-coder-lite/bin/lib/workstream-inventory-builder.generated.cjs.
 *
...
async function main() {
  ...
  const outPath = fileURLToPath(
    new URL('../../evolv-coder-lite/bin/lib/workstream-inventory-builder.generated.cjs', import.meta.url),
  );

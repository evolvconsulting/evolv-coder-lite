...
const roadmapParser = require('../evolv-coder-lite/bin/lib/roadmap-parser.cjs');
...
describe('roadmap-parser: getMilestonePhaseFilter', () => {
  ...
  test('adversarial: bracket-prefixed phase heading ### [eCL] Phase 2-01:', () => {
    writeState(tmpDir, { milestone: 'v2.0' });
    writeRoadmap(tmpDir, [
      '## v2.0: Bracket',
      '### [eCL] Phase 2-01: Setup',
      '### [eCL] Phase 2-02: Build',
    ].join('\n'));

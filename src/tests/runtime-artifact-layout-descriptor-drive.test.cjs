...
const {
  ...
  path.join(ROOT, 'evolv-coder-lite', 'bin', 'lib', 'runtime-artifact-layout.cjs'),
);
...
const GOLDEN = {
  // ── claude ──────────────────────────────────────────────────────────────────
  'claude/global': [
    { kind: 'skills', destSubpath: 'skills', prefix: 'ecl-' },
  ],
  'claude/local': [
    { kind: 'commands', destSubpath: 'commands/ecl', prefix: 'ecl-' },
    { kind: 'agents',   destSubpath: 'agents',       prefix: 'ecl-' },
  ],
  ...
  'cursor/global': [
    { kind: 'skills',   destSubpath: 'skills',   prefix: 'ecl-' },
    { kind: 'commands', destSubpath: 'commands',  prefix: 'ecl-' },
  ],
  'cursor/local': [
    { kind: 'skills',   destSubpath: 'skills',   prefix: 'ecl-' },
    { kind: 'commands', destSubpath: 'commands',  prefix: 'ecl-' },
  ...
  // Old switch: no scope branch → local == global. 5b backfill restores this.
  'hermes/global': [
    { kind: 'skills', destSubpath: 'skills/ecl', prefix: 'ecl-' },
  ],
  'hermes/local': [
    { kind: 'skills', destSubpath: 'skills/ecl', prefix: 'ecl-' },
  ],
  ...
  'kimi/global': [
    { kind: 'skills',      destSubpath: 'skills', prefix: 'ecl-' },
    { kind: 'kimi-agents', destSubpath: 'agents', prefix: 'ecl'  },
  ],
  'kimi/local': [],
  ...
  // Old switch: no scope branch → local == global. 5b backfill restores this.
  'opencode/global': [
    { kind: 'commands', destSubpath: 'command', prefix: 'ecl-' },
    { kind: 'skills',   destSubpath: 'skills',  prefix: 'ecl-' },
  ],
  'opencode/local': [
    { kind: 'commands', destSubpath: 'command', prefix: 'ecl-' },

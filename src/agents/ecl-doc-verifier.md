...
Spawned by the `/ecl:docs-update` workflow. Each spawn receives a `<verify_assignment>` XML block containing:
...
- **eCL marker**: The comment `<!-- generated-by: ecl-doc-writer -->` — skip entirely.

...
For deep ecosystem research ("how do experts build this"), use `/ecl:plan-phase --research-phase` which produces RESEARCH.md.
...
- Use `/ecl:plan-phase --research-phase` for these
</guidelines>

/**
 * Tests for issue #2912 — /ecl-progress can use stale CLAUDE.md project block
 * instead of eCL tracking files as authoritative source.
 *
 * Fix: the `report` step in evolv-coder-lite/workflows/progress.md must contain

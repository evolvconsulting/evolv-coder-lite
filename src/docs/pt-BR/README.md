...
- [Integrando uma base de código existente](tutorials/onboarding-an-existing-codebase.md) — leve o eCL Core a um repositório já existente
...
- [Lidar com tarefas rápidas e ágeis](how-to/handle-quick-and-fast-tasks.md) — usar `/ecl-quick` e `/ecl-fast` para trabalho avulso fora do ciclo de fases
...
- [Explorar e esboçar](how-to/spike-and-sketch.md) — usar `/ecl-spike` e `/ecl-sketch` para trabalho exploratório antes de comprometer com um plano
- [Projetar uma fase de UI](how-to/design-a-ui-phase.md) — usar o ciclo de fase de UI para trabalho de frontend e visual
- [Conduzir o eCL a partir de uma issue do rastreador](how-to/drive-ecl-from-a-tracker-issue.md) — iniciar uma fase a partir de uma issue do GitHub, Linear ou Jira
- [Migrar do eCL 2](how-to/migrate-from-ecl-2.md) — atualizar um projeto eCL 2 existente para o eCL Core
- [Atualizar o eCL](how-to/update-ecl.md) — executar novamente o instalador para obter a versão mais recente
...
- [Ferramentas CLI](CLI-TOOLS.md) — API programática `ecl-tools.cjs` para workflows e agentes
...
- [Engenharia de contexto](explanation/context-engineering.md) — como a degradação de contexto se forma e como o eCL Core a previne
...
- [Modos de discussão](workflow-discuss-mode.md) — modo de suposições vs. modo de entrevista para `/ecl-discuss-phase`
- [Monitoramento de contexto](context-monitor.md) — arquitetura do hook de monitoramento da janela de contexto
- [Orquestração orientada por issues](issue-driven-orchestration.md) — receita para conduzir o eCL a partir de uma issue do rastreador usando primitivos existentes

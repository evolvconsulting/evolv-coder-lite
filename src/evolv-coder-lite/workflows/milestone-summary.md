...
4. If nothing found: error "No milestone found. Run /ecl:new-project or /ecl:new-milestone first."
...
```bash
$ECL_SDK query commit "docs(v${VERSION}): generate milestone summary for onboarding" --files \
...
If the user is done:
- Suggest next steps: `/ecl:new-milestone`, `/ecl:progress`, or sharing the summary with the team

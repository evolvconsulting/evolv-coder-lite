...
// Content-assertion contract for the ecl-verifier agent: the
...
const standaloneTemplatePath = path.join(ROOT, 'evolv-coder-lite', 'templates', 'verification-report.md');
...
const verifyPhase = fs.readFileSync(path.join(ROOT, 'evolv-coder-lite', 'workflows', 'verify-phase.md'), 'utf-8');

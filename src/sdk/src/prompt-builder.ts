...
/**
 * Extract the tools list from a ecl-executor.md agent definition.
...
/**
 * Extract the role instructions from a ecl-executor.md agent definition.
...
export interface ExecutorPromptOptions {
  /** Raw content of ecl-executor.md agent definition. */
  agentDef?: string;

...
- `/ecl:discuss-phase 2 --assumptions` — check assumptions
...
**Also available:**
- `/ecl:discuss-phase 2` — gather context first
- `/ecl:plan-phase --research-phase 2` — investigate unknowns
- Review roadmap
...
**Also available:**
- `/ecl:discuss-phase 3` — gather context first
- `/ecl:plan-phase --research-phase 3` — investigate unknowns
...
**To plan directly:** `/ecl:plan-phase 3`

**To discuss context first:** `/ecl:discuss-phase 3`

**To research unknowns:** `/ecl:plan-phase --research-phase 3`

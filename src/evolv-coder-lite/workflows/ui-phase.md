<purpose>
Generate a UI design contract (UI-SPEC.md) for frontend phases. Orchestrates ecl-ui-researcher and ecl-ui-checker with a revision loop. Inserts between discuss-phase and plan-phase in the lifecycle.
...
```
UI phase is disabled in config. Enable via /ecl:settings.
```
Exit workflow.
...
Recommended: run /ecl:discuss-phase {N} first to capture design preferences.
...
⚡ Sketch findings detected: {SKETCH_FINDINGS_PATH}
   Validated design decisions from /ecl:sketch will be loaded into the UI researcher.
...
## 5. Spawn ecl-ui-researcher

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 eCL ► UI DESIGN CONTRACT — PHASE {N}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/ecl-ui-researcher.md for instructions.
...
- {SKETCH_FINDINGS_PATH} (Sketch Findings — validated design decisions, CSS patterns, visual direction from /ecl:sketch, if exists)
</files_to_read>
...
Template: ~/.claude/evolv-coder-lite/templates/UI-SPEC.md
</output>
...
Agent(
  ...
  subagent_type="ecl-ui-researcher",
...
## 7. Spawn ecl-ui-checker

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 eCL ► VERIFYING UI-SPEC
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/ecl-ui-checker.md for instructions.
...
- Re-spawn ecl-ui-researcher with revision context:
...
2. Edit manually — open UI-SPEC.md in editor, re-run /ecl:ui-phase
...
`/clear` then: `/ecl:plan-phase {N}`

{If CONTEXT.md does NOT exist:}
**Discuss Phase {N}** — gather implementation context before planning

`/clear` then: `/ecl:discuss-phase {N}`

(or `/ecl:plan-phase {N}` to skip discussion)
...
- [ ] ecl-ui-researcher spawned with correct context and file paths
- [ ] UI-SPEC.md created in correct location
- [ ] ecl-ui-checker spawned with UI-SPEC.md

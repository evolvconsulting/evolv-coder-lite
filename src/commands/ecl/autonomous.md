...
Project context, phase list, and state are resolved inside the workflow using init commands (`ecl-sdk query init.milestone-op`, `ecl-sdk query roadmap.analyze`). No upfront context loading needed.
</context>

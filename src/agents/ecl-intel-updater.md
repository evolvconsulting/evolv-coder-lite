...
```bash
ecl-tools intel patch-meta .planning/intel/stack.json 
```
...
```bash
ecl-tools intel patch-meta .planning/intel/files.json 
```
...
```bash
ecl-tools intel patch-meta .planning/intel/apis.json 
```
...
```bash
ecl-tools intel patch-meta .planning/intel/deps.json 
```

/**
 * Session scan — parity with `evolv-coder-lite/bin/lib/profile-pipeline.cjs` `cmdScanSessions`.
 * Used by `scanSessions` query handler so SDK JSON matches `ecl-tools.cjs scan-sessions --json`.
 */

...
const cjs = fs.readFileSync(join(root, 'evolv-coder-lite/bin/lib/profile-output.cjs'), 'utf-8');
...
const header = `/**
 * Synced from evolv-coder-lite/bin/lib/profile-output.cjs (PROFILING_QUESTIONS, CLAUDE_INSTRUCTIONS).

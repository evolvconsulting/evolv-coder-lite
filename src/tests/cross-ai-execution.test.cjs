...
const CONFIG_PATH = path.join(__dirname, '..', 'evolv-coder-lite', 'bin', 'lib', 'config.cjs');
const EXECUTE_PHASE_PATH = path.join(__dirname, '..', 'evolv-coder-lite', 'workflows', 'execute-phase.md');
const CONFIG_TEMPLATE_PATH = path.join(__dirname, '..', 'evolv-coder-lite', 'templates', 'config.json');

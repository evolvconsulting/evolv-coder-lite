...
// /ecl: rewrite applies in `copyWithPathReplacement` to JS files under the
// agent/skill tree (.cursor/evolv-coder-lite/*.js etc). We verify that Cursor's
// installed .js files under .cursor/ have no /ecl: colon refs.
// ---------------------------------------------------------------------------

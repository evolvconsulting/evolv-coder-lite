/**
 * eCL Tools Tests - reapply-patches post-merge verification
 *
 ...
 * evolv-coder-lite/workflows/reapply-patches.md.
 */
...
const WORKFLOW_PATH = path.join(
  __dirname, '..', 'evolv-coder-lite', 'workflows', 'reapply-patches.md'
);

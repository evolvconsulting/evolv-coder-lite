...
describe('PHASE_AGENT_MAP', () => {
  ...
  it('execute maps to ecl-executor.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Execute]).toBe('ecl-executor.md');
  });

  it('research maps to ecl-phase-researcher.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Research]).toBe('ecl-phase-researcher.md');
  });

  it('plan maps to ecl-planner.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Plan]).toBe('ecl-planner.md');
  });

  it('verify maps to ecl-verifier.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Verify]).toBe('ecl-verifier.md');
  });

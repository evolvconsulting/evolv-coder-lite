...
const PROBE_CORE_LIB = path.join(__dirname, '..', 'evolv-coder-lite', 'bin', 'lib', 'probe-core.cjs');
...
//
// RED-first: these assertions require the BUILT evolv-coder-lite/bin/lib/prohibition-enforcement.cjs,

# Referência de Agentes do eCL

Este documento descreve os papéis dos agentes especializados no ecossistema eCL.  
...
O eCL usa um **orquestrador leve** para coordenar subagentes especializados por etapa:

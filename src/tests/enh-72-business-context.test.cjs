...
const TEMPLATE = path.join(__dirname, '..', 'evolv-coder-lite', 'templates', 'project.md');
const COMPLETE_MILESTONE = path.join(__dirname, '..', 'evolv-coder-lite', 'workflows', 'complete-milestone.md');

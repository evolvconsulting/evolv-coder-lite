...
/**
 * eCL Tools Tests - Seed Scan in New Milestone (#2169)
 *
...
const NEW_MILESTONE_PATH = path.join(ROOT, 'evolv-coder-lite', 'workflows', 'new-milestone.md');
const PLANT_SEED_PATH = path.join(ROOT, 'evolv-coder-lite', 'workflows', 'plant-seed.md');

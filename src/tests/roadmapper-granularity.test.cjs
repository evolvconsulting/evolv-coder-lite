...
// agents/ecl-roadmapper.md is the deployed agent — the Granularity Calibration table
...
describe('ecl-roadmapper granularity calibration (#163)', () => {
  const section = granularitySection(readAgent('ecl-roadmapper'));
...
describe('ecl-roadmapper phase_id_convention support (#1205)', () => {
  const content = readAgent('ecl-roadmapper');

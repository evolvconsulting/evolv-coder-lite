...
eCL Core's discuss-phase offers two modes for gathering implementation context before planning begins. Understanding when to use each helps you move from question-answering to a confirmed `CONTEXT.md` with less back-and-forth.
...
- [Discuss a phase](how-to/discuss-a-phase.md) — step-by-step how-to for running `/ecl-discuss-phase` in either mode.

 ...
 *
 * Provides a cross-project learnings store at ~/.ecl/knowledge/.
...
const DEFAULT_STORE_DIR = path.join(os.homedir(), '.ecl', 'knowledge');
...
/**
 * Handle `ecl-tools learnings list`
...
/**
 * Handle `ecl-tools learnings query --tag <tag>`
 * @param {string} tag
 * @param {boolean} raw - Raw output flag
 */
...
/**
 * Handle `ecl-tools learnings copy`
...
/**
 * Handle `ecl-tools learnings prune --older-than <duration>`
...
/**
 * Handle `ecl-tools learnings delete <id>`
 * @param {string} id
 * @param {boolean} raw - Raw output flag
 */

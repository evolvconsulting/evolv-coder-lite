...
/**
 * eCL Tools Tests - discuss-phase incremental checkpoint saves
 *
...
describe('discuss-phase incremental checkpoint saves (#1485)', () => {
  ...
  const defaultModePath = path.join(__dirname, '..', 'evolv-coder-lite', 'workflows', 'discuss-phase', 'modes', 'default.md');
  const checkpointTplPath = path.join(__dirname, '..', 'evolv-coder-lite', 'workflows', 'discuss-phase', 'templates', 'checkpoint.json');

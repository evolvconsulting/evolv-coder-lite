...
<execution_context>
@~/.claude/evolv-coder-lite/workflows/execute-phase.md
...
Context files are resolved inside the workflow via `ecl-tools query init.execute-phase` and per-subagent `<files_to_read>` blocks.
</context>

...
const LEGACY_HINT = 'npx evolv-coder-lite-cc@latest --claude --local';
const CURRENT_HINT = 'npx -y @evolvconsulting/evolv-coder-lite@latest --claude --local';
...
test('bug #170: workflow fallback hints do not reference evolv-coder-lite-cc', () => {

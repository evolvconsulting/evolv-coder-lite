...
const CONFIG_CJS_PATH = path.join(__dirname, '..', 'evolv-coder-lite', 'bin', 'lib', 'config.cjs');
const SHIP_MD_PATH = path.join(__dirname, '..', 'evolv-coder-lite', 'workflows', 'ship.md');

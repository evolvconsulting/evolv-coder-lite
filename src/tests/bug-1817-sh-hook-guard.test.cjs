...
const SH_HOOKS = [
  { name: 'ecl-validate-commit.sh', settingsVar: 'validateCommitCommand' },
  { name: 'ecl-session-state.sh',   settingsVar: 'sessionStateCommand' },
  { name: 'ecl-phase-boundary.sh',  settingsVar: 'phaseBoundaryCommand' },
];

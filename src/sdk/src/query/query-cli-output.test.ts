...
describe('query-cli-output', () => {
  it('prefers raw ecl-tools stderr when present', () => {
  ...
  it('falls back to Error: message when ecl-tools stderr is empty', () => {
  ...
  it('falls back to Error: message when ecl-tools stderr is whitespace-only', () => {
  ...
  it('uses exitCode 1 when ecl-tools exitCode is null and stderr is non-empty', () => {

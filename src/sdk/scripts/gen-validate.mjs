 ...
 * evolv-coder-lite/bin/lib/validate.generated.cjs.
 *
 ...
 *   - Issue #6 (evolvconsulting/evolv-coder-lite)
 *   - Issue #26 (evolvconsulting/evolv-coder-lite) — #26 extends issue #6's generator
 ...
 *   - ADR-3524 (docs/adr/3524-cjs-sdk-hard-seam.md)
 *   - Issue #6 (evolvconsulting/evolv-coder-lite)
 *   - Issue #26 (evolvconsulting/evolv-coder-lite)
 *   - PR #154 (issue #4) — generator pattern precedent
 *   - PR #156 (issue #6) — validate.ts generator that #26 extends
 */
...
async function main() {
  ...
  const outPath = fileURLToPath(
    new URL('../../evolv-coder-lite/bin/lib/validate.generated.cjs', import.meta.url),
  );

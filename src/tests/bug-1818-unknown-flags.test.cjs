 ...
 *
 * Original #1818 invariant: ecl-tools must NOT silently ignore --help/-h
 ...
 * subcommand discoverability for `ecl-sdk query <subcommand> --help`.
 *
 ...
 *
 * --version remains rejected — it's never a valid ecl-tools flag and has

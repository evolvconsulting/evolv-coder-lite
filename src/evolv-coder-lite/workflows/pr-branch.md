...
don't see eCL transient artifacts (PLAN.md, SUMMARY.md, CONTEXT.md, RESEARCH.md, etc.)
...
TARGET=${1:-$(ecl_run query git.base-branch)}
```
...
Or use /ecl:ship to create the PR automatically.
```
</step>

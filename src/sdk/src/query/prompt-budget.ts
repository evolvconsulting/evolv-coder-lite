 ...
 *
 * Port of evolv-coder-lite/bin/lib/prompt-budget.cjs + the `case 'prompt-budget':`
 * block in evolv-coder-lite/bin/ecl-tools.cjs.
 *
 * CLI call surface (via `ecl-sdk query prompt-budget`):
...
/**
 * SDK handler for `ecl-sdk query prompt-budget`.
 *

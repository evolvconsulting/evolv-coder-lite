...
- This section feeds directly into /ecl:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /ecl:plan-phase --gaps with root causes
...
**Creation:** When /ecl:verify-work starts new session
...
- `/ecl:verify-work {phase}` picks up from first pending/blocked test

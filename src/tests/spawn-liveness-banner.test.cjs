...
// Tests that every eCL workflow that spawns a subagent carries the liveness phrase
// "runs in a subagent" on its spawn announcement lines.
// Canonical phrase defined in evolv-coder-lite/references/ui-brand.md § Spawning Indicators.
// Regression test for https://github.com/evolvconsulting/evolv-coder-lite/issues/558.
//
  ...
  test('every ◆ spawn announcement line carries the liveness phrase "runs in a subagent"', () => {
    ...
    assert.deepStrictEqual(
      ...
      `The following ◆ spawn announcement lines are missing the liveness phrase "${LIVENESS_PHRASE}":\n` +
        ...
        '\n\nPer evolv-coder-lite/references/ui-brand.md § "Spawning Indicators":\n' +
        ...
        'See https://github.com/evolvconsulting/evolv-coder-lite/issues/558'
    );
  });

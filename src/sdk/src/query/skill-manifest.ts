 ...
 * `evolv-coder-lite/bin/lib/init.cjs` (lines 1640–1847).
...
/**
 * Scan canonical skill roots and build manifest JSON (same shape as ecl-tools.cjs).
 */
  ...
  const canonicalRoots = skillsDir
    ...
    : [
      ...
      },
      {
        ...
        path: join(homedir(), '.claude', 'commands', 'ecl'),
...
/**
 * `skill-manifest` — same flags as ecl-tools: `--skills-dir`, `--write`.
 */

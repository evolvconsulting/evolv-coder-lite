...
<objective>
Capture ideas, tasks, notes, and seeds to their appropriate destination in the eCL system.
...
<execution_context>
@~/.claude/evolv-coder-lite/workflows/add-todo.md
@~/.claude/evolv-coder-lite/workflows/note.md
@~/.claude/evolv-coder-lite/workflows/add-backlog.md
@~/.claude/evolv-coder-lite/workflows/plant-seed.md
@~/.claude/evolv-coder-lite/workflows/check-todos.md

...
This directory contains Architecture Decision Records (ADRs) for eCL.
...
| [0007-sdk-package-seam-module.md](0007-sdk-package-seam-module.md) | SDK Package Seam Module owns SDK-to-evolv-coder-lite compatibility | Superseded by ADR-0174 |
...
| [0011-review-default-reviewers.md](0011-review-default-reviewers.md) | Review default-reviewers selection policy for /ecl:review | Accepted |
...
| [0174-retire-ecl-sdk-package-boundary.md](0174-retire-ecl-sdk-package-boundary.md) | Retire @evolvconsulting/ecl-sdk package boundary — single-runtime collapse | Accepted |
...
| [766-claude-code-plugin-manifest-module.md](766-claude-code-plugin-manifest-module.md) | Claude Code Plugin Manifest Module owns the projection of evolv-coder-lite surfaces onto the Claude Code plugin contract | Accepted |
...
profile staging (`--profile=<name>`, `.ecl-profile` marker, `requires:` closure)
and the Phase 2 runtime `/ecl:surface` command for cluster-level enable/disable
without reinstall.

...
async function main(): Promise<void> {
  ...
  // Also generate the CJS mirror used by evolv-coder-lite/bin/lib/ seams.
  // CJS is plain JavaScript — no type annotations.
  const cjsOutPath = fileURLToPath(new URL('../../evolv-coder-lite/bin/lib/command-aliases.generated.cjs', import.meta.url));

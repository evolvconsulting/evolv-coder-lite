<purpose>
One-page newcomer-oriented tour of eCL Core. Output ONLY the `<reference>` content below. No additions.
</purpose>

<reference>
# eCL Core — Git. Ship. Done.

Plan-driven development for solo agentic work with Claude Code. eCL Core turns a vague idea into a hierarchical plan, then executes it phase by phase with state tracking and atomic commits.

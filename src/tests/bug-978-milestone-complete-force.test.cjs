...
/**
 * Regression test for bug #978: `ecl-tools milestone complete --force` was a
 ...
 * CLI dispatcher (evolv-coder-lite/bin/ecl-tools.cjs) never parsed `--force` and never
...
describe('bug-978: milestone complete --force overrides unstarted-phase guard', () => {
  ...
  beforeEach(() => {
    tmpDir = createTempProject('ecl-bug-978-');
  });

 ...
 *
 * After #3042 deleted /ecl-research-phase (replaced by
 * /ecl-plan-phase --research-phase <N>) and v1.40.0 consolidated /ecl-insert-phase
 * into /ecl-phase insert, six occurrences survived in agents/*.md because none of
 ...
 * runs the /ecl- → /ecl: namespace transform, not retired-name replacement.
 *

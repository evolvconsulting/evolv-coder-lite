...
const REFERENCE_PATH = path.join(__dirname, '..', 'evolv-coder-lite', 'references', 'planning-config.md');
const CORE_PATH = path.join(__dirname, '..', 'evolv-coder-lite', 'bin', 'lib', 'config-loader.cjs');

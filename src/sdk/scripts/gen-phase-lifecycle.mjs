 ...
 *
 * Emits evolv-coder-lite/bin/lib/phase-lifecycle.generated.cjs which provides
...
async function main() {
  ...
  const outPath = fileURLToPath(
    new URL('../../evolv-coder-lite/bin/lib/phase-lifecycle.generated.cjs', import.meta.url),
  );

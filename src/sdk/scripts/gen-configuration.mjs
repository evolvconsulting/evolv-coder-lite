#!/usr/bin/env node
/**
 * Generator for evolv-coder-lite/bin/lib/configuration.generated.cjs.
 *
...
export function buildConfigurationCjs() {
  return [
    ...
    `  const candidates = [`,
    `    // Installed runtime layout: evolv-coder-lite/bin/shared/*.manifest.json`,
...
if (process.argv[1] === _thisFile) {
  ...
  const outPath = resolve(repoRoot, 'evolv-coder-lite', 'bin', 'lib', 'configuration.generated.cjs');

...
const { routeCjsCommandFamily, routeHubCommandFamily } = require('../evolv-coder-lite/bin/lib/cjs-command-router-adapter.cjs');
const { makeInvalidArgs } = require('../evolv-coder-lite/bin/lib/command-routing-hub.cjs');

...
<execution_context>
@~/.claude/evolv-coder-lite/workflows/add-phase.md
@~/.claude/evolv-coder-lite/workflows/insert-phase.md
@~/.claude/evolv-coder-lite/workflows/remove-phase.md
@~/.claude/evolv-coder-lite/workflows/edit-phase.md
</execution_context>

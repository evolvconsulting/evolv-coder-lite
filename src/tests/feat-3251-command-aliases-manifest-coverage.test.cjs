...
const ECL_TOOLS = path.join(REPO_ROOT, 'evolv-coder-lite', 'bin', 'ecl-tools.cjs');
...
function createProject() {
  const dir = fs.mkdtempSync(path.join(os.tmpdir(), 'ecl-3251-dispatch-'));
...
describe('feat-3251: generated aliases dispatch through real ecl-tools behavior', () => {

...
const PAUSE_WORK = path.join(__dirname, '..', 'evolv-coder-lite', 'workflows', 'pause-work.md');
const DISCUSS_PHASE = path.join(__dirname, '..', 'evolv-coder-lite', 'workflows', 'discuss-phase.md');

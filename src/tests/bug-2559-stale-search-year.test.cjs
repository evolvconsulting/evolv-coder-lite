 ...
 *
 * The ecl-phase-researcher and ecl-project-researcher agents instruct
...
const PHASE_RESEARCHER = path.join(
  ...
  '..',
  'agents',
  'ecl-phase-researcher.md'
);
const PROJECT_RESEARCHER = path.join(
  __dirname,
  '..',
  'agents',
  'ecl-project-researcher.md'
);

const FILES = [
  { label: 'ecl-phase-researcher.md', path: PHASE_RESEARCHER },
  { label: 'ecl-project-researcher.md', path: PROJECT_RESEARCHER },
];

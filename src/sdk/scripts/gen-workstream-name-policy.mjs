 ...
 * then emits evolv-coder-lite/bin/lib/workstream-name-policy.generated.cjs.
 *
...
async function main() {
  ...
  const outPath = fileURLToPath(
    new URL('../../evolv-coder-lite/bin/lib/workstream-name-policy.generated.cjs', import.meta.url),
  );

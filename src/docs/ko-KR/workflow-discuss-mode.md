...
eCL Core의 discuss-phase는 계획 전에 구현 컨텍스트를 수집하기 위한 두 가지 모드를 제공한다. 각 모드를 언제 사용해야 하는지 이해하면 더 적은 주고받음으로 확인된 `CONTEXT.md`에 도달할 수 있다.
...
- [단계 논의하기](how-to/discuss-a-phase.md) — 두 모드 중 하나로 `/ecl-discuss-phase`를 실행하는 단계별 how-to.

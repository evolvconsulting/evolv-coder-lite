...
- Gated real-CLI SDK E2E suites behind explicit opt-in (`ECL_ENABLE_E2E=1`) to keep default CI/local verification deterministic while preserving full-path validation when requested.

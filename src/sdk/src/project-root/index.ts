 ...
 * evolv-coder-lite/bin/lib/project-root.generated.cjs is generated from this file.
 */
 ...
 *
 * Ported from `evolv-coder-lite/bin/lib/core.cjs:findProjectRoot` so that
 * `ecl-sdk query` resolves the same parent `.planning/` root as the legacy
 * `ecl-tools.cjs` CLI when invoked inside a `sub_repos`-listed child repo.
 *

...
const PROMPT_PATH = path.join(__dirname, '..', 'evolv-coder-lite', 'templates', 'planner-subagent-prompt.md');
...
// which nothing loads at runtime (no @-import in agents/ecl-planner.md, no read in plan-phase.md).

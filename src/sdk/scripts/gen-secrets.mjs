 ...
 * then emits evolv-coder-lite/bin/lib/secrets.generated.cjs.
 *
 ...
 * credentials managed via /ecl-settings-integrations.
...
async function main() {
  ...
  const outPath = fileURLToPath(
    new URL('../../evolv-coder-lite/bin/lib/secrets.generated.cjs', import.meta.url),
  );

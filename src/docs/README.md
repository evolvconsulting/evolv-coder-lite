...
Comprehensive documentation for the evolv Coder Lite (eCL) framework — a meta-prompting, context engineering, and spec-driven development system for AI coding agents.
...
| [Custom PR Body Sections](ship-pr-body-sections.md) | All users | How to append project-specific PRD sections to `/ecl-ship` PR bodies |
| [CLI Tools Reference](CLI-TOOLS.md) | Contributors, agent authors | `ecl-tools.cjs` programmatic API for workflows and agents |
| [JSON Error Mode](json-errors.md) | Contributors, agent authors | Machine-readable `ecl-tools --json-errors` failure envelopes |
...
| [Issue-Driven Orchestration](issue-driven-orchestration.md) | All users | Recipe for driving eCL from a tracker issue (GitHub / Linear / Jira) using existing primitives — no new commands or daemon |
...
- **Getting started:** [README](../README.md) → install → `/ecl-new-project`
- **Full workflow walkthrough:** [User Guide](USER-GUIDE.md)
- **All commands at a glance:** [Command Reference](COMMANDS.md)
- **Configuring eCL:** [Configuration Reference](CONFIGURATION.md)

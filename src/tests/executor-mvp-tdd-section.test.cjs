/**
 * ecl-executor agent — MVP+TDD gate section contract
...
const AGENT = path.join(__dirname, '..', 'agents', 'ecl-executor.md');
const REF = path.join(__dirname, '..', 'evolv-coder-lite', 'references', 'execute-mvp-tdd.md');

describe('ecl-executor — MVP+TDD gate section', () => {

...
const FAMILIES = [
  ...
  {
    name: 'commands',
    dir: path.join(ROOT, 'commands', 'ecl'),
    filter: (f) => f.endsWith('.md'),
    toName: (f) => '/ecl-' + f.replace(/\.md$/, ''),
  },
  {
    name: 'workflows',
    dir: path.join(ROOT, 'evolv-coder-lite', 'workflows'),
    filter: (f) => f.endsWith('.md'),
    toName: (f) => f,
  },
  {
    name: 'references',
    dir: path.join(ROOT, 'evolv-coder-lite', 'references'),
    filter: (f) => f.endsWith('.md'),
    toName: (f) => f,
  },
  {
    name: 'cli_modules',
    dir: path.join(ROOT, 'evolv-coder-lite', 'bin', 'lib'),

/**
 * Read-only subprocess golden checks (SDK vs ecl-tools.cjs JSON).
...
describe('Read-only golden parity (JSON toEqual)', () => {
  it.each(STABLE_JSON_PARITY_ROWS)('$canonical matches ecl-tools.cjs JSON', async (row) => {
...
describe('config-path (plain stdout vs SDK { path })', () => {
  it('SDK path matches ecl-tools.cjs plain-text stdout', async () => {
...
describe('audit-open golden parity (excluding scanned_at)', () => {
  it('SDK JSON matches ecl-tools.cjs except volatile scanned_at', async () => {
...
describe('state.json golden parity (excluding last_updated)', () => {
  it('SDK rebuilt frontmatter matches ecl-tools.cjs except volatile last_updated', async () => {
...
describe('summary.extract golden parity (with array-of-objects fix)', () => {
  it('SDK JSON matches ecl-tools.cjs except for intentional array-of-objects parsing fix', async () => {
...
describe('state.load golden parity', () => {
  it('SDK load payload matches ecl-tools.cjs state load', async () => {
...
describe('verify.commits golden parity', () => {
  it('SDK output matches ecl-tools.cjs for two SHAs', async () => {

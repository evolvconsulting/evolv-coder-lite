...
**Creates/Updates:**
- No files created directly — dispatches to existing eCL commands via Skill() and background Task agents.
...
Read and execute `~/.claude/evolv-coder-lite/workflows/analyze-dependencies.md` end-to-end.

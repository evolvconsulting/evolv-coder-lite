...
// update.md is loaded verbatim by the runtime as the /ecl-update workflow.
...
/**
 * Bug #3608: evolv-coder-lite/workflows/update.md does not model Antigravity as
 * a first-class runtime, so /ecl-update invoked from an Antigravity install
 ...
 * agree, or /ecl-update routes Antigravity installs through the base Gemini
 * path.
 *

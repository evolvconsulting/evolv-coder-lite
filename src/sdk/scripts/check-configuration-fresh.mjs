#!/usr/bin/env node
/**
 * Freshness check for evolv-coder-lite/bin/lib/configuration.generated.cjs.
 *
...
const committedPath = resolve(repoRoot, 'evolv-coder-lite', 'bin', 'lib', 'configuration.generated.cjs');

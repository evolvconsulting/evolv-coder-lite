...
<execution_context>
@~/.claude/evolv-coder-lite/workflows/spec-phase.md
@~/.claude/evolv-coder-lite/templates/spec.md
</execution_context>
...
- User knows they can now run /ecl:discuss-phase which will load SPEC.md automatically
</success_criteria>

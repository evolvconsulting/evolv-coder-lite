...
// Step-C section of ecl-phase-researcher.md and ecl-project-researcher.md.
...
describe('research-agent-profiles: provider dispatch parity', () => {
  ...
  const SEAM_AGENTS = ['ecl-phase-researcher', 'ecl-project-researcher'];

  // Load PROVIDER_WATERFALL from the compiled seam module.
  const { PROVIDER_WATERFALL } = require('../evolv-coder-lite/bin/lib/research-provider.cjs');

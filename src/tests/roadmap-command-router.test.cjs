...
const { routeRoadmapCommand } = require('../evolv-coder-lite/bin/lib/roadmap-command-router.cjs');
...
// `process.env.ECL_WORKSTREAM` being unset, so set it here to deterministically

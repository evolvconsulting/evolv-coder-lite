...
- Tracking issue: [#456](https://github.com/evolvconsulting/evolv-coder-lite/issues/456)
- ESLint harness: `452-eslint-lint-harness.md`
- Warn-to-error follow-up: [#453](https://github.com/evolvconsulting/evolv-coder-lite/issues/453)

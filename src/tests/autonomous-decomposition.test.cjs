...
const AUTONOMOUS_PATH = path.join(PROJECT_ROOT, 'evolv-coder-lite', 'workflows', 'autonomous.md');
const SMART_DISCUSS_REF = path.join(PROJECT_ROOT, 'evolv-coder-lite', 'references', 'autonomous-smart-discuss.md');

 ...
 *
 * Seam: evolv-coder-lite/workflows/cleanup.md
 *
 * Verifies that /ecl-cleanup prunes local branches whose upstream is gone,
...
const CLEANUP_PATH = path.join(REPO_ROOT, 'evolv-coder-lite', 'workflows', 'cleanup.md');

...
describe('agent-skills command', () => {
  ...
  test('returns empty when no config exists', () => {
    ...
    const result = runGsdTools(['agent-skills', 'ecl-executor'], tmpDir, { HOME: tmpDir, USERPROFILE: tmpDir });
  ...
  test('returns empty for unconfigured agent type', () => {
    ...
    const result = runGsdTools(['agent-skills', 'ecl-planner'], tmpDir, { HOME: tmpDir, USERPROFILE: tmpDir });
    assert.strictEqual(result.output, '');
  });
...
describe('agent-skills global: prefix', () => {
  ...
  test('global:valid-skill resolves to $HOME/.claude/skills/valid-skill/SKILL.md', () => {
    ...
    const result = runGsdTools(['agent-skills', 'ecl-executor'], tmpDir, { HOME: fakeHome, USERPROFILE: fakeHome });

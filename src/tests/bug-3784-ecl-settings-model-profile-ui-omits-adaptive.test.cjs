 ...
 *
 * /ecl-settings model profile UI omits `adaptive`. The AskUserQuestion block
 ...
 * reachable by name via `ecl:config --profile adaptive` but cannot be selected
 * interactively through `/ecl:settings`.
 *

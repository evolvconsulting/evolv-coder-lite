#!/usr/bin/env node
/**
 * Copy eCL hooks to dist for installation.
...
// helpers (e.g. hooks/lib/ecl-graphify-rebuild.sh) resolve from the hook's
...
function build() {
  ...
  for (const hook of HOOKS_TO_COPY) {
    ...
    // hooks lacked their "# ecl-hook-version:" header. POSIX rename(2)

 ...
 * that belongs in `evolv-coder-lite/references/` (lazily loaded) or a per-mode
 ...
 *   - https://github.com/evolvconsulting/evolv-coder-lite/issues/2551 (this test)
 *   - https://github.com/evolvconsulting/evolv-coder-lite/issues/2361 (agent budget)
  ...
  for (const workflow of ALL_WORKFLOWS) {
    ...
    test(`${workflow} (${tier}) stays under ${limit} bytes`, () => {
      ...
      assert.ok(
        ...
        `to evolv-coder-lite/references/ — and load them LAZILY (not via @-required_reading, ` +

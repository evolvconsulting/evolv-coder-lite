 ...
 * ECL_WORKSTREAM or ECL_PROJECT environment context.
 *
 * Port of planningDir() workspace logic from evolv-coder-lite/bin/lib/core.cjs
...
export interface WorkspaceContext {
  /** Active workstream name (from ECL_WORKSTREAM env var), or null */
  workstream: string | null;
  /** Active project name (from ECL_PROJECT env var), or null */
  project: string | null;
}
...
/**
 * Read ECL_WORKSTREAM and ECL_PROJECT environment variables.
 *
...
export function resolveWorkspaceContext(): WorkspaceContext {
  return {
    workstream: process.env['ECL_WORKSTREAM'] || null,
    project: process.env['ECL_PROJECT'] || null,
  };
}

/**
 * ecl-verifier agent — MVP Mode Verification section contract
...
const AGENT = path.join(__dirname, '..', 'agents', 'ecl-verifier.md');
const REF = path.join(__dirname, '..', 'evolv-coder-lite', 'references', 'verify-mvp-mode.md');
...
describe('ecl-verifier — MVP Mode Verification section', () => {

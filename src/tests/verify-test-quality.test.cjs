...
// Structural guard: reads evolv-coder-lite/workflows/verify-phase.md and asserts that
...
describe('verify-phase.md audit_test_quality structural guard', () => {
  test('verify-phase.md exists at evolv-coder-lite/workflows/verify-phase.md', () => {
    assert.ok(
      fs.existsSync(WORKFLOW_PATH),

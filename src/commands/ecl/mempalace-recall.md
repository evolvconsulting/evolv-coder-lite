...
**DO NOT use `ecl-tools config get-value`** -- it hard-exits on missing keys.
...
MemPalace memory is disabled. To activate:
  ...
  node <runtime-home>/evolv-coder-lite/bin/ecl-tools.cjs config-set mempalace.enabled true

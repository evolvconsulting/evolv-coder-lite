...
- **Net-new bootstrap** (`--mode new`, default when `.planning/` is absent): produces PROJECT.md + REQUIREMENTS.md + ROADMAP.md + STATE.md from synthesized doc content, delegating final generation to `ecl-roadmapper`.
...
<execution_context>
@~/.claude/evolv-coder-lite/workflows/ingest-docs.md

...
<objective>
Analyze existing codebase using parallel ecl-codebase-mapper agents to produce structured codebase documents.
...
<execution_context>
@~/.claude/evolv-coder-lite/workflows/map-codebase.md
</execution_context>
...
- Before /ecl:new-project (brownfield codebases) - creates codebase map first
- After /ecl:new-project (greenfield codebases) - updates codebase map as code evolves
...
3. Spawn 4 parallel ecl-codebase-mapper agents:
...
7. Offer next steps (typically: /ecl:new-project or /ecl:plan-phase)
</process>

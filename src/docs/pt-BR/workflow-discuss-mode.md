...
A fase de discuss do eCL Core oferece dois modos para coletar o contexto de implementação antes do início do planejamento. Entender quando usar cada um ajuda a passar da fase de perguntas para um `CONTEXT.md` confirmado com menos idas e vindas.
...
- [Realizar discuss de uma fase](how-to/discuss-a-phase.md) — passo a passo para executar `/ecl-discuss-phase` em qualquer modo.

...
2. Present evolvconsulting continuity messaging in concise, team-owned language.
3. Provide explicit migration guidance from legacy packages to `@evolvconsulting/*`.
...
1. README contains a continuity notice naming `evolvconsulting/evolv-coder-lite` as canonical.

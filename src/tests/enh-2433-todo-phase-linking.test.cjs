...
/**
 * Tests for ecl-new-milestone todo-to-phase linking (#2433).
...
const NEW_MILESTONE = fs.readFileSync(
  path.join(ROOT, 'evolv-coder-lite/workflows/new-milestone.md'), 'utf-8'
);
const EXECUTE_PHASE = fs.readFileSync(
  path.join(ROOT, 'evolv-coder-lite/workflows/execute-phase.md'), 'utf-8'
);

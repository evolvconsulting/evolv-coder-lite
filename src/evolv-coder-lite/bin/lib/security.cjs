 ...
 *
 * This module centralizes security checks for eCL tooling. Because eCL generates
 ...
 *
 * These address browser-side and agent-side risks when eCL plan files containing

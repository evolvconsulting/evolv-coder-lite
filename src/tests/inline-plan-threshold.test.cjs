...
const executePlanPath = path.join(repoRoot, 'evolv-coder-lite', 'workflows', 'execute-plan.md');
const planningConfigPath = path.join(repoRoot, 'evolv-coder-lite', 'references', 'planning-config.md');

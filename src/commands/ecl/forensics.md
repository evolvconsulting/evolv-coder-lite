...
type: prompt
name: ecl:forensics
description: Post-mortem investigation for failed eCL workflows — diagnoses what went wrong.
...
<objective>
Investigate what went wrong during a eCL workflow execution. Analyzes git history, `.planning/` artifacts, and file system state to detect anomalies and generate a structured diagnostic report.
...
<execution_context>
@~/.claude/evolv-coder-lite/workflows/forensics.md
</execution_context>

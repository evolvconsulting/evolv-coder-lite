#!/usr/bin/env bash
# Release monitor for evolvconsulting/evolv-coder-lite
# Checks every 15 minutes, writes new release info to a signal file

REPO="evolvconsulting/evolv-coder-lite"
SIGNAL_FILE="/tmp/ecl-new-release.json"
STATE_FILE="/tmp/ecl-monitor-last-tag"
LOG_FILE="/tmp/ecl-monitor.log"

...
describe('autonomous workflow ui-phase and ui-review integration (#1375)', () => {
  ...
  describe('step 3a.5 — UI design contract before planning', () => {
    ...
    test('UI design contract step invokes ecl:ui-phase skill', () => {
      assert.ok(
        content.includes('skill="ecl-ui-phase"'),
        'should invoke ecl-ui-phase via Skill()'
      );
    });
  ...
  describe('step 3d.5 — UI review after execution', () => {
    ...
    test('UI review step invokes ecl:ui-review skill', () => {
      assert.ok(
        content.includes('skill="ecl-ui-review"'),
        'should invoke ecl-ui-review via Skill()'
      );
    });

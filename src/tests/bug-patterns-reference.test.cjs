...
const REFERENCE_PATH = path.join(
  __dirname, '..', 'evolv-coder-lite', 'references', 'common-bug-patterns.md'
);
const DEBUGGER_AGENT_PATH = path.join(
  __dirname, '..', 'agents', 'ecl-debugger.md'
);
...
describe('debugger agent references bug patterns', () => {
  ...
  test('ecl-debugger.md references common-bug-patterns.md', () => {

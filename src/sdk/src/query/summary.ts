 ...
 *
 * Ported from evolv-coder-lite/bin/lib/commands.cjs (cmdSummaryExtract, cmdHistoryDigest).
 ...
 * Port of `extractOneLinerFromBody` from `evolv-coder-lite/bin/lib/core.cjs`.
 */

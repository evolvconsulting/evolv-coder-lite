...
function versionFile(dir: string): string { return path.join(dir, 'evolv-coder-lite', 'VERSION'); }
function markerFile(dir: string): string { return path.join(dir, 'evolv-coder-lite', 'workflows', 'update.md'); }

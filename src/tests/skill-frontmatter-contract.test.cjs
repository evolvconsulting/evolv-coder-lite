...
// The commands/ecl/*.md and evolv-coder-lite/workflows/*.md files are the
...
// ─── #3042: --research-phase flag wired into /ecl-plan-phase ────────────────
// (Moved from bug-3042-3044-research-flag-and-stale-refs.test.cjs)

describe('skill frontmatter: /ecl-plan-phase --research-phase flag absorbs the standalone research command', () => {
  test('commands/ecl/plan-phase.md argument-hint advertises --research-phase', () => {
    const content = read('commands/ecl/plan-phase.md');
  ...
  test('workflows/plan-phase.md parses --research-phase and sets a research-only mode', () => {
    const content = read('evolv-coder-lite/workflows/plan-phase.md');
  ...
  test('orphaned workflows/research-phase.md is removed', () => {
    assert.equal(
      exists('evolv-coder-lite/workflows/research-phase.md'),
      false,
      'workflows/research-phase.md must be removed; the capability now lives on /ecl-plan-phase --research-phase'
    );
  });

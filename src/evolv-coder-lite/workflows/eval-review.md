<purpose>
Retroactive audit of an implemented AI phase's evaluation coverage. Standalone command that works on any eCL-managed AI phase. Produces a scored EVAL-REVIEW.md with gap analysis and remediation plan.

Use after /ecl:execute-phase to verify that the evaluation strategy from AI-SPEC.md was actually implemented. Mirrors the pattern of /ecl:ui-review and /ecl:validate-phase.
</purpose>
...
```bash
AUDITOR_MODEL=$(ecl_run query resolve-model ecl-eval-auditor 2>/dev/null | jq -r '.model' 2>/dev/null || true)
AGENT_SKILLS_AUDITOR=$(ecl_run query agent-skills ecl-eval-auditor)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 eCL ► EVAL AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**State C** — No SUMMARY.md: Exit — "Phase {N} not executed. Run /ecl:execute-phase {N} first."
...
Consider running /ecl:ai-integration-phase {N} before implementation next time.
```
...
```markdown
Read ~/.claude/agents/ecl-eval-auditor.md for instructions.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 eCL ► EVAL AUDIT COMPLETE — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
{If PRODUCTION READY:}
  Next step: /ecl:plan-phase (next phase) or deploy

{If NEEDS WORK:}
  Address critical gaps in EVAL-REVIEW.md, then re-run /ecl:eval-review {N}
...
- [ ] ecl-eval-auditor spawned with correct context

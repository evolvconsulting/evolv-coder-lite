 ...
 * @param {string} configDir      runtime config dir (for .ecl-source marker resolution)
 */
...
function resolveRuntimeArtifactLayout(runtime, configDir, scope = 'global') {
  ...
  switch (runtime) {
    ...
    case 'cursor':
      kinds = [skillsKind('skills', 'ecl-', 'convertClaudeCommandToCursorSkill', 'cursor', configDir)];
      break;
    ...
    case 'augment':
      kinds = [skillsKind('skills', 'ecl-', 'convertClaudeCommandToAugmentSkill', 'augment', configDir)];
      break;
    ...
    case 'codebuddy':
      kinds = [skillsKind('skills', 'ecl-', 'convertClaudeCommandToCodebuddySkill', 'codebuddy', configDir)];
      break;
    ...
    case 'opencode':
      kinds = [commandsKind('command', 'ecl-', configDir)];
      break;

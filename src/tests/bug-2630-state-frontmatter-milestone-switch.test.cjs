 ...
 * body in a single atomic write. Prior to the fix, the `/ecl:new-milestone`
...
describe('state milestone-switch (#2630)', () => {
  ...
  test('rejects missing --milestone', () => {
    ...
    // ecl-tools emits JSON with { error: ... } to stdout even on error paths.

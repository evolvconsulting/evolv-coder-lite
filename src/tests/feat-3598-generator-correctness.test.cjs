...
const CJS_GENERATORS = [
  { script: 'gen-configuration.mjs',                  exportName: 'buildConfigurationCjs',              committed: 'evolv-coder-lite/bin/lib/configuration.generated.cjs' },
  { script: 'gen-project-root.mjs',                   exportName: 'buildProjectRootCjs',                committed: 'evolv-coder-lite/bin/lib/project-root.generated.cjs' },
  { script: 'gen-state-document.ts',                  exportName: 'buildStateDocumentCjs',              committed: 'evolv-coder-lite/bin/lib/state-document.generated.cjs' },
  { script: 'gen-workstream-inventory-builder.mjs',   exportName: 'buildWorkstreamInventoryBuilderCjs', committed: 'evolv-coder-lite/bin/lib/workstream-inventory-builder.generated.cjs' },
  { script: 'gen-decisions.mjs',                      exportName: 'buildDecisionsCjs',                  committed: 'evolv-coder-lite/bin/lib/decisions.generated.cjs' },
  { script: 'gen-plan-scan.mjs',                      exportName: 'buildPlanScanCjs',                   committed: 'evolv-coder-lite/bin/lib/plan-scan.generated.cjs' },
  { script: 'gen-schema-detect.mjs',                  exportName: 'buildSchemaDetectCjs',               committed: 'evolv-coder-lite/bin/lib/schema-detect.generated.cjs' },
  { script: 'gen-secrets.mjs',                        exportName: 'buildSecretsCjs',                    committed: 'evolv-coder-lite/bin/lib/secrets.generated.cjs' },
  { script: 'gen-workstream-name-policy.mjs',         exportName: 'buildWorkstreamNamePolicyCjs',       committed: 'evolv-coder-lite/bin/lib/workstream-name-policy.generated.cjs' },
];
...
describe('feat-3598: command-aliases CJS and TS surfaces expose the same alias set', () => {
  const CJS_PATH = path.join(REPO_ROOT, 'evolv-coder-lite', 'bin', 'lib', 'command-aliases.generated.cjs');
...
describe('feat-3598: live command registry has no duplicate aliases', () => {
  ...
  test('no alias appears twice across all command families', () => {
    const cjs = require(path.join(
      REPO_ROOT, 'evolv-coder-lite', 'bin', 'lib', 'command-aliases.generated.cjs',
    ));

...
Spikes live in `.planning/spikes/` and integrate with eCL commit patterns, state tracking,
...
<execution_context>
@~/.claude/evolv-coder-lite/workflows/spike.md
@~/.claude/evolv-coder-lite/workflows/spike-wrap-up.md

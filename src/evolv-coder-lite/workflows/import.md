...
INIT=$(ecl_run query init.phase-op "{NN}")
...
```bash
ecl_run query commit "docs({phase}): import plan from {basename FILEPATH}" --files .planning/phases/{phase}/{plan}-PLAN.md .planning/ROADMAP.md
```

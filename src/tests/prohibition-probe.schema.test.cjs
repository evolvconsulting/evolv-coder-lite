...
// the block-name-generic parseMustHavesBlock @ src/frontmatter.cts:207 (built to evolv-coder-lite/bin/lib/
...
const FRONTMATTER_LIB = path.join(__dirname, '..', 'evolv-coder-lite', 'bin', 'lib', 'frontmatter.cjs');

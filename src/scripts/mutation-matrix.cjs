 ...
 *     "matrix": {
 *       "include": [
 *         { "name": "<module>", "mutate": "evolv-coder-lite/bin/lib/<module>.cjs", "tests": "<space-joined test files>" },
 *         ...
 *       ]
 *     }
 *   }
...
const COVERED = {
  'context-utilization': {
    cjs: 'evolv-coder-lite/bin/lib/context-utilization.cjs',
    tests: [
  ...
  'prompt-budget': {
    cjs: 'evolv-coder-lite/bin/lib/prompt-budget.cjs',
    tests: [
  ...
  frontmatter: {
    cjs: 'evolv-coder-lite/bin/lib/frontmatter.cjs',
    tests: [
  ...
  'adr-parser': {
    cjs: 'evolv-coder-lite/bin/lib/adr-parser.cjs',
    tests: [
  ...
  'config-schema': {
    cjs: 'evolv-coder-lite/bin/lib/config-schema.cjs',
    tests: [
  ...
  'active-workstream-store': {
    cjs: 'evolv-coder-lite/bin/lib/active-workstream-store.cjs',
    tests: [
  ...
  'core-utils': {
    cjs: 'evolv-coder-lite/bin/lib/core-utils.cjs',
    tests: [

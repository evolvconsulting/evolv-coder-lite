...
// deep dirs (02-04-01-deep), and project-code-prefixed variants (eCL-02-01-setup).
...
// multi-segment tokens like "02-01" from "02-01-setup" or "eCL-02-01-setup".
...
export function buildRoadmapPhaseVariants(roadmapContent: string): RoadmapPhaseVariantsResult {
  ...
  // and bracket-prefixed (### [eCL] Phase 2-01:) headings.

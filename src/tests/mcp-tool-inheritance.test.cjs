...
describe('MCP tool usage in eCL agents', () => {
  const agentFiles = [
    path.join(__dirname, '..', 'agents', 'ecl-executor.md'),
    path.join(__dirname, '..', 'agents', 'ecl-planner.md'),
  ];
  ...
  test('ecl-executor.md explicitly instructs to use available MCP tools', () => {
...
describe('Researcher agents declare mcp__tavily/ref/jina tools (#657)', () => {
  const researcherAgents = [
    path.join(__dirname, '..', 'agents', 'ecl-project-researcher.md'),
    path.join(__dirname, '..', 'agents', 'ecl-phase-researcher.md'),
    path.join(__dirname, '..', 'agents', 'ecl-ui-researcher.md'),
  ];
...
describe('researcher Step-C dispatch ↔ tools frontmatter parity (#1284)', () => {
  const RESEARCHERS = ['ecl-phase-researcher', 'ecl-project-researcher'];

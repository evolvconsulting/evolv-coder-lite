 ...
 *
 * Follows the pattern of tests/bug-2767-ecl-sdk-commit-files-flag.test.cjs.
 ...
 * CLI for `ecl commit`, and asserts the resulting branch matches the resolved
...
describe('bug #3749 (integration): ecl-sdk commit with branching_strategy: phase', () => {
  let tmpDir;

  beforeEach(() => {
    tmpDir = createTempGitProject('ecl-3749-');

...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /ecl:plan-phase --research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/evolv-coder-lite/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/evolv-coder-lite/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/evolv-coder-lite/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/evolv-coder-lite/templates/discovery.md
...
Use ~/.claude/evolv-coder-lite/templates/discovery.md.
...
1. Discuss phase context (/ecl:discuss-phase [current-phase])
2. Create phase plan (/ecl:plan-phase [current-phase])

 ...
 *
 * Post-ADR-0174 the `@evolvconsulting/ecl-sdk` package was retired; `sdk/` no longer
...
describe('bug #505: dead SDK verification subsystem removed from bin/install.js', () => {
  ...
  // formatStaleStandaloneSdkWarning) and the ecl-sdk shim contract surface
  // (buildWindowsShimTriple, formatSdkPathDiagnostic) that #505 kept were
  // removed when the ecl-sdk shim itself was retired (#191). Their absence is

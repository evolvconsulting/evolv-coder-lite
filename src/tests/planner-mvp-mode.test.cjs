/**
 * ecl-planner agent — MVP-mode branch contract
...
const AGENT = path.join(__dirname, '..', 'agents', 'ecl-planner.md');
const REF_MVP = path.join(__dirname, '..', 'evolv-coder-lite', 'references', 'planner-mvp-mode.md');
const REF_SKEL = path.join(__dirname, '..', 'evolv-coder-lite', 'references', 'skeleton-template.md');

describe('ecl-planner — MVP-mode branch', () => {

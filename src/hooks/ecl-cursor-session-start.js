...
// ecl-cursor-session-start.js — Cursor sessionStart hook (issue #777)
//
...
//   - If absent, nudges the user toward /ecl:new-project.
...
const MSG_PRESENT =
  'eCL: .planning/STATE.md is present — review the current phase and any blockers before acting.';
const MSG_ABSENT =
...
process.stdin.on('end', () => {
  ...
  try {
    ...
    // Fail open — never block a Cursor session because of a eCL hook error.
